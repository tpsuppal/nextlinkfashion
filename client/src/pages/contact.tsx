            ...
            <div className="lg:col-span-3 bg-white p-8 md:p-10 rounded-2xl shadow-xl border border-black/5">
              ...
              <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="company" placeholder="Your Brand Ltd." data-testid="input-company" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="message" placeholder="Tell us about your production needs, volume, and timelines..." rows={5} data-testid="input-message" />
                </div>
                
                <Button type="submit" className="w-full bg-primary text-white h-12 text-lg hover:bg-primary/90" data-testid="btn-submit-contact">
                  Submit Inquiry
                </Button>
              </form>
            </div>
              ...
              <div className="bg-primary text-primary-foreground p-8 rounded-2xl shadow-lg">
                ...
                <div className="space-y-6">
                  <div className="flex gap-4 items-start">
                    <svg className="w-6 h-6 shrink-0 mt-1 text-accent" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinelinejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>
                    <div>
                      <p className="font-bold">Nextlink Fashion Inc Limited</p>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-primary-foreground/80">+852 1234 5678</p>
                    </div>
                  </div>
                  
                  <div className="flex gap-4 items-start">
                    <svg className="w-6 h-6 shrink-0 mt-1 text-accent" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinelinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                    <div>
                      <p className="font-bold">Email</p>
                      <p className="text-primary-foreground/80">inquiries@nextlinkfashion.com</p>
                    </div>
                  </div>
                </div>
              </div>
